...
for x in range(7):
  ...
  print(str(wait_time) + unit[0])

print("\nTotal Step Time: " + f"{round(total_step_time, 1)} days")
print("\nTotal Wait Time: " + f"{round(total_wait_time, 1)} days")
total_lead_time = total_step_time + total_wait_time
print("\nTotal Lead Time: " + f"{round(total_lead_time, 1)} days")
print("\nStep Time as a % of Lead Time: " +f"{total_step_time/total_lead_time:.0%}")
